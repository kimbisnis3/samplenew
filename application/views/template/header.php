...
<ul class="sub-menu">
	...
	<li id="menu-item-3314" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="<?php echo base_url('/'); ?>profil/<?php echo $t->slug ?>"><span class="avia-bullet"></span><span class="avia-menu-text"><?php echo $t->judul ?></span></a></li>
<?php } ?>
...
<ul class="sub-menu">
	...
	<li id="menu-item-3314" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="<?php echo base_url('/'); ?>ppdb/<?php echo $t->slug ?>"><span class="avia-bullet"></span><span class="avia-menu-text"><?php echo $t->judul ?></span></a></li>
<?php } ?>
...
<ul class="sub-menu">
	...
	<li id="menu-item-3314" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="<?php echo base_url('/'); ?>kesiswaan/<?php echo $t->slug ?>"><span class="avia-bullet"></span><span class="avia-menu-text"><?php echo $t->judul ?></span></a></li>
<?php } ?>
...
<li id="menu-item-3316" class="fasilitas menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-top-level menu-item-top-level-2"><a href="<?php echo base_url('/'); ?>fasilitas"><span class="avia-bullet"></span><span class="avia-menu-text">Fasilitas</span><span class="avia-menu-fx"><span class="avia-arrow-wrap"><span class="avia-arrow"></span></span></span></a>

<ul class="sub-menu">
	<?php foreach( $fasilitas as $t ) { ?>
	<li id="menu-item-3314" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="<?php echo base_url('/'); ?>fasilitas/<?php echo $t->slug ?>"><span class="avia-bullet"></span><span class="avia-menu-text"><?php echo $t->judul ?></span></a></li>
<?php } ?>
...
<ul class="sub-menu">
	...
	<li id="menu-item-3314" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="<?php echo base_url('/'); ?>kurikulum/<?php echo $t->slug ?>"><span class="avia-bullet"></span><span class="avia-menu-text"><?php echo $t->judul ?></span></a></li>
<?php } ?>
...
<ul class="sub-menu">
	...
	<li id="menu-item-3314" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="<?php echo base_url('/'); ?>berita/<?php echo $t->slug ?>"><span class="avia-bullet"></span><span class="avia-menu-text"><?php echo $t->judul ?></span></a></li>
<?php } ?>
...
<ul class="sub-menu">
	...
	<li id="menu-item-3314" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="<?php echo base_url('/'); ?>artikel/<?php echo $t->slug ?>"><span class="avia-bullet"></span><span class="avia-menu-text"><?php echo $t->judul ?></span></a></li>
<?php } ?>
